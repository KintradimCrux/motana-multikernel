Motana Multi-Kernel App Console - Symfony `[symfony-version]` (kernel: boot, env: test, debug: false)
=========================================================================================
...
* Usage:
  ...
  * `bin/console list [options] [--] [<kernel>] [<command>] [<namespace>]`
  * `bin/console <kernel> list [--raw] [--format FORMAT] [-h|--help] [-q|--quiet] [-v|vv|vvv|--verbose] [-V|--version] [--ansi] [--no-ansi] [-n|--no-interaction] [-e|--env ENV] [--no-debug] [--] [<kernel>] [<command>] [<namespace>]`
